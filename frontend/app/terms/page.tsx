          ...
          <div className="space-y-10 text-sm md:text-base text-neutral-700 leading-relaxed">
            ...
            <section>
              ...
              <ol className="list-none space-y-3">
                ...
                <li>
                  ⑤ 회사는 유료서비스 구독 회원에게 매 결제일마다 구독
                  등급(Tier)에 따른 일정량의 크레딧을 제공합니다.
                </li>
                <li>
                  ⑥ 크레딧은 서비스 내 기능 이용 시 소비되며, 미사용
                  크레딧은 다음 결제일로 이월되지 않고 소멸됩니다.
                </li>
                <li>
                  ⑦ 크레딧의 종류, 수량 및 소비 기준은 서비스 내 가격 안내
                  또는 요금제 페이지에서 확인할 수 있습니다.
                </li>
              </ol>
            </section>
